...
//---	GPS位置控制位置速度环PID参数	
	Ano_Parame.set.pid_gps_loc_1level[KP] = 0.12f;          //位置控制位置速度环PID参数
	Ano_Parame.set.pid_gps_loc_1level[KI] = 0.00f;          //位置控制位置速度环PID参数
...
{
	//参数初始化
	Ano_Parame.set.pwmInMode = DBUS;     /*设置遥控器接收机的模式为DBUS*/
